      ...
      <Container>
        <Row style={{ display: "flex" }}>
          <div className="home-text">
            ...
            Unify VIT Computer Department: One Virtual Platform
            </div>
          ...
          <div className="section-image">
            <img className="img-new" src="https://www.infince.com/wp-content/uploads/2023/05/Best_video_meeting_platform-min.png" alt="App Preview" />
          </div>
        </Row>
      </Container>
    </section>
